...
import org.example.sol.sdk.utils.ShortvecEncoding;
...
public class Message {
    ...
    public void setFeePayer(String feePayer) {
        setFeePayer(new PublicKey(feePayer));
    }
    ...
    public void addProgramId(String programIdBase58) {
        if (!this.programIds.contains(programIdBase58)) {
            this.programIds.add(programIdBase58);
        }
    }

    public void addProgramId(PublicKey programId) {
        addProgramId(programId.toBase58());
    }
}
